      ...
      <div class="flex flex-col md:flex-row gap-3 items-stretch md:items-center justify-between">
        ...
        <div class="flex items-center gap-2">
          <div class="relative">
            <select
              v-model="sortBy"
              class="appearance-none pl-3 pr-8 py-2 rounded-xl bg-surface-1 border border-border/80 text-xs font-semibold text-text-primary focus:outline-none focus:border-amber-500 cursor-pointer"
            >
              <option value="popular">Most Popular</option>
              <option value="price-asc">Lowest Fare (EGP)</option>
              <option value="duration-asc">Shortest Duration</option>
              <option value="trips-desc">Most Daily Trips</option>
            </select>
            <Icon
              name="ph:caret-down-bold"
              class="w-3 h-3 text-text-muted absolute right-2.5 top-1/2 -translate-y-1/2 pointer-events-none"
            />
          </div>
