<template>
  <footer
    ...
    <div class="border-b border-border/60 bg-surface-1/50 dark:bg-[#0E1424]">
      <div
        class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-wrap items-center justify-between gap-4 text-[11px]">
        ...
        <div class="flex items-center gap-2.5">
          ...
          <div class="flex items-center gap-1 font-mono text-[9px] font-black tracking-wider">
            <span
              class="px-2 py-0.5 rounded bg-surface-0 dark:bg-[#131B2E] border border-border/70 text-text-primary">FAWRY</span>
            <span
              class="px-2 py-0.5 rounded bg-surface-0 dark:bg-[#131B2E] border border-border/70 text-text-primary">MEEZA</span>
            <span
              class="px-2 py-0.5 rounded bg-surface-0 dark:bg-[#131B2E] border border-border/70 text-[#EA580C] dark:text-orange-400 font-bold">VODAFONE
              CASH</span>
            <span
              class="px-2 py-0.5 rounded bg-surface-0 dark:bg-[#131B2E] border border-border/70 text-text-primary">VISA
              / MC</span>
          </div>
        </div>
      </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10">
        ...
        <div class="lg:col-span-4 space-y-4">
          ...
          <p class="text-xs text-text-secondary leading-relaxed max-w-sm">
            Egypt's premier intercity bus reservation platform. Seamless booking
            across Cairo, Alexandria, Sharm El Sheikh, Hurghada, Luxor, and all
            27 governorates.
          </p>
        ...
        <div class="hidden md:block lg:col-span-2 space-y-3">
          ...
          <ul class="space-y-2.5 text-xs">
            <li>
              <nuxt-link-locale to="/about" class="text-text-secondary hover:text-[#EA580C] transition-colors">
                About Us
              </nuxt-link-locale>
            </li>
            <li class="flex items-center gap-1.5">
              <nuxt-link-locale to="/careers" class="text-text-secondary hover:text-[#EA580C] transition-colors">
                Careers
              </nuxt-link-locale>
              <span
                class="bg-[#EA580C] text-white text-[9px] font-extrabold px-1.5 py-0.2 rounded-full uppercase tracking-wider">
                Hiring
              </span>
            </li>
            <li>
              <nuxt-link-locale to="/contact" class="text-text-secondary hover:text-[#EA580C] transition-colors">
                Contact Us
              </nuxt-link-locale>
            </li>
            <li>
              <nuxt-link-locale to="/press" class="text-text-secondary hover:text-[#EA580C] transition-colors">
                Press & Media Kit
              </nuxt-link-locale>
            </li>
            <li>
              <nuxt-link-locale to="/stations" class="text-text-secondary hover:text-[#EA580C] transition-colors">
                Station Directory
              </nuxt-link-locale>
            </li>
          </ul>
        ...
        <div class="hidden md:block lg:col-span-2 space-y-3">
          ...
          <ul class="space-y-2.5 text-xs">
            ...
            <li>
              <nuxt-link-locale to="/cancellation" class="text-text-secondary hover:text-[#EA580C] transition-colors">
                Cancellation & Refund Policy
              </nuxt-link-locale>
            </li>
            <li>
              <nuxt-link-locale to="/faq" class="text-text-secondary hover:text-[#EA580C] transition-colors">
                Frequently Asked Questions (FAQ)
              </nuxt-link-locale>
            </li>
            <li>
              <nuxt-link-locale to="/luggage" class="text-text-secondary hover:text-[#EA580C] transition-colors">
                Luggage & Baggage Rules
              </nuxt-link-locale>
            </li>
            <li>
              <nuxt-link-locale to="/passenger-rights" class="text-text-secondary hover:text-[#EA580C] transition-colors">
        ...
        <div class="hidden md:block lg:col-span-2 space-y-3">
          ...
          <ul class="space-y-2.5 text-xs">
            ...
            <li>
              <nuxt-link-locale to="/operators/portal" class="text-text-secondary hover:text-[#EA580C] transition-colors">
                Fleet Operator Portal
              </nuxt-link-locale>
            </li>
            <li>
              <nuxt-link-locale to="/operators/api" class="text-text-secondary hover:text-[#EA580C] transition-colors">
                Terminal Integration API
              </nuxt-link-locale>
            </li>
            <li>
              <nuxt-link-locale to="/operators#stories" class="text-text-secondary hover:text-[#EA580C] transition-colors">
                Operator Success Stories
              </nuxt-link-locale>
            </li>
            <li>
              <nuxt-link-locale to="/safety" class="text-text-secondary hover:text-[#EA580C] transition-colors">
        ...
        <div class="hidden md:block lg:col-span-2 space-y-4">
          ...
          <p class="text-[11px] text-text-secondary leading-relaxed">
            Stay updated with highway schedule releases, travel alerts, and
            regional discounts.
          </p>
          ...
          <div
            ...
            <div class="flex items-center gap-2">
              <span
                class="w-7 h-7 rounded-full bg-[#EA580C] text-white flex items-center justify-center text-[10px] font-black shrink-0">
                24/7
              </span>
      ...
      <div class="block md:hidden mt-8">
        <LazyVAccordion v-model="openAccordions" :items="footerAccordionItems" :multiple="true">
          <!-- Slot: Company -->
          <template #company>
            <div class="space-y-2 text-xs">
              <nuxt-link-locale to="/about" class="block text-text-secondary hover:text-[#EA580C]">About Us</nuxt-link-locale>
              <nuxt-link-locale to="/careers" class="block text-text-secondary hover:text-[#EA580C]">Careers</nuxt-link-locale>
              <nuxt-link-locale to="/contact" class="block text-text-secondary hover:text-[#EA580C]">Contact Us</nuxt-link-locale>
              <nuxt-link-locale to="/press" class="block text-text-secondary hover:text-[#EA580C]">Press & Media Kit</nuxt-link-locale>
              <nuxt-link-locale to="/stations" class="block text-text-secondary hover:text-[#EA580C]">Station Directory</nuxt-link-locale>
            </div>
          </template>
          ...
          <template #travelers>
            <div class="space-y-2 text-xs">
              ...
              <nuxt-link-locale to="/cancellation" class="block text-text-secondary hover:text-[#EA580C]">Cancellation Policy</nuxt-link-locale>
              <nuxt-link-locale to="/faq" class="block text-text-secondary hover:text-[#EA580C]">FAQ</nuxt-link-locale>
              <nuxt-link-locale to="/luggage" class="block text-text-secondary hover:text-[#EA580C]">Luggage & Baggage</nuxt-link-locale>
              <nuxt-link-locale to="/passenger-rights" class="block text-text-secondary hover:text-[#EA580C]">Passenger Rights (Egypt MOT)</nuxt-link-locale>
            </div>
          </template>

          <!-- Slot: For Bus Operators -->
          <template #operators>
            <div class="space-y-2 text-xs">
              <nuxt-link-locale to="/operators" class="block font-bold text-[#EA580C]">Partner With Us →</nuxt-link-locale>
              <nuxt-link-locale to="/operators/portal" class="block text-text-secondary hover:text-[#EA580C]">Fleet Operator Portal</nuxt-link-locale>
              <nuxt-link-locale to="/operators/api" class="block text-text-secondary hover:text-[#EA580C]">Terminal Integration API</nuxt-link-locale>
              <nuxt-link-locale to="/safety" class="block text-text-secondary hover:text-[#EA580C]">Safety Standards Compliance</nuxt-link-locale>
            </div>
          </template>
            ...
            <div class="pt-1 space-y-3 text-xs">
              <div class="flex items-center gap-2">
                <a href="https://facebook.com" target="_blank" rel="noopener" aria-label="Facebook"
                  class="w-8 h-8 rounded-lg bg-surface-0 dark:bg-[#131B2E] border border-border flex items-center justify-center text-text-secondary hover:text-[#EA580C]">
                  <Icon name="ri:facebook-fill" class="w-4 h-4" />
                </a>
    ...
    <div class="border-t border-border/60 bg-surface-1/40 dark:bg-[#0E1424]">
      <div
        class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px]">
        ...
        <div class="flex flex-wrap items-center justify-center sm:justify-start gap-x-3 gap-y-1 text-text-muted">
          ...
          <nuxt-link-locale to="/terms" class="hover:text-text-primary transition-colors">
            Terms of Service
          </nuxt-link-locale>
          <span>•</span>
          <nuxt-link-locale to="/privacy" class="hover:text-text-primary transition-colors">
            Privacy Policy
          </nuxt-link-locale>
          <span>•</span>
          <button type="button" class="hover:text-text-primary transition-colors cursor-pointer"
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="relative">
            <button type="button"
              ...
              <Icon name="ph:caret-down-bold" class="w-3 h-3 text-text-muted transition-transform"
          ...
          <div class="relative">
            <button type="button"
              ...
              langMenuOpen = false;
              ">
              <span class="font-extrabold text-[#EA580C]">{{
...
// ─── Mobile Accordion Items (For Travelers active by default as in spec) ─────
const openAccordions = ref<(string | number)[]>(["travelers"]);

const footerAccordionItems: AccordionItem[] = [
  { id: "company", title: "Company" },
  { id: "travelers", title: "For Travelers (Active)", active: true },
  { id: "operators", title: "For Bus Operators" },
  { id: "social", title: "Follow Us" },
];
